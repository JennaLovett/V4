    ...
    <ul>
      <li style="float:left;"> 
        <a href="#home" style="color: #183A37;"><strong>V4</strong></a>
                ...
                <li class="hover"><a href="#post">Post</a></li>
                <li class="hover"><a href="#rewards">Rewards</a></li>
                <li class="hover"><a href="#volunteer">Volunteer</a></li>
                <li class="hover"><a href="dashboard.html">Dashboard</a></li>
    </ul>
  </nav>
    <div class="container">
        <div class="toppane">
            ...
            <h3 id="h3m">Opportunities Volunteered For</h3>
                <div class="borders">
                   <!--- <div><button type="button" value="null" id="button">X</button></div> -->
                    ...
                    <img src="/images/corgi.jpg" alt="Corgi" height="130" width="250">
                <p class="p1">
                ...
                <div class="borders">
                    <img src="/images/build.jpg" alt="house" height="130" width="250">
                <p class="p1">
                ...
                <div class="borders">
                    <img src="/images/cs.jpg" alt="house" height="130" width="250">
                <p class="p1">
